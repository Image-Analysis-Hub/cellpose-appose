...
See full documentation [here](https://imagej.net/plugins/fiji-cellpose).

## Plugin Installation

You can install the plugin for the update site `Fiji-Cellpose`:
in Fiji, go to `Help>Update...` then to `Manage Update Sites` in the window that opens.
Look for `Fiji-Cellpose`in the list of update sites and select it.
